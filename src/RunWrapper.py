...
if __name__ == "__main__":
    ...
    config = "gribanov", "launch_network_default_graph", "launch_network_default_settings", 10000
    # config = "gribanov", "launch_conveyors_default_graph", "launch_conveyors_default_settings", 10000
    ...
    """ Select the command: """
    # simulate/train:
    # command, command_args = "run", "--routing_algorithms=reinforce_emb_global"
    # command, command_args = "run", "--routing_algorithms=reinforce_emb"
    # command, command_args = "run", "--routing_algorithms=dqn_emb_global"
    command, command_args = "run", "--routing_algorithms=dqn_emb,dqn_emb_global"
    # command, command_args = "run", "--routing_algorithms=dqn_centralized"
    # command, command_args = "run", "--routing_algorithms=dqn"
    # command, command_args = "run", "--routing_algorithms=glob_dyn"
    # command, command_args = "run", "--routing_algorithms=link_state"
    # command, command_args = "run", "--routing_algorithms=simple_q"
